...
*/
  ...
  CUDA_SAFE_CALL(cudaMemcpy2DAsync(d_u1, pitch_bytes, h_u1, sizeof(float) * NX,
                              sizeof(float) * NX, NY * NZ,
  ...
  CUT_SAFE_CALL(cutStartTimer(hTimer));
  CUDA_SAFE_CALL(cudaMemcpy2DAsync(h_u2, sizeof(float) * NX, d_u1, pitch_bytes,
                              sizeof(float) * NX, NY * NZ,
