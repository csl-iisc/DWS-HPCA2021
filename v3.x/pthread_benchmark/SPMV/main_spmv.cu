...
int main_spmv(cudaStream_t stream_app, pthread_mutex_t* mutexapp, bool flag) {
  ...
  inputData("/home/pratheek-htc/masksim/v3.x/pthread_benchmark/SPMV/Dubcova2.mtx.bin", &len, &depth, &dim, &nzcnt_len, &pad,
  ...
  // pb_SwitchToTimer(&timers, pb_TimerID_IO);
  outputData("/home/pratheek-htc/masksim/v3.x/pthread_benchmark/SPMV/Dubcova2.mtx.out", h_Ax_vector, dim);
